...
##### ERROR when I ran ./run_demo.sh
##### Error: Input file './person_detect.tflite' doesn't exist, is a broken symbolic link, or a directory.
##### run the following command manully to get "modlue.tar".
##### It's OK after correcting dir of input file.
python3 -m tvm.driver.tvmc compile --target=cmsis-nn,c \
    ...
    --pass-config tir.disable_vectorize=1 \
     $script_dir/WDCNNQuant_v1.tflite \
    --output-format=mlf \
...
cd ..
python3 ./convert_image.py $script_dir/validation_feature.txt
python3 ./convert_labels.py $script_dir/validation_label.txt
echo "2"
