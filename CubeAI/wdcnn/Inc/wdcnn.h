...
#include "wdcnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_WDCNN_MODEL_NAME          "wdcnn"
#define AI_WDCNN_ORIGIN_MODEL_NAME   "wdcnnquant_v1"

/******************************************************************************/
#define AI_WDCNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_WDCNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WDCNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WDCNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_WDCNN_IN \
  ai_wdcnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WDCNN_IN_SIZE { \
  AI_WDCNN_IN_1_SIZE, \
}
#define AI_WDCNN_IN_SIZE_BYTES { \
  AI_WDCNN_IN_1_SIZE_BYTES, \
}
#define AI_WDCNN_IN_1_HEIGHT      (1024)
#define AI_WDCNN_IN_1_CHANNEL     (1)
#define AI_WDCNN_IN_1_SIZE        (1024 * 1)
#define AI_WDCNN_IN_1_SIZE_BYTES  (4096)

/******************************************************************************/
#define AI_WDCNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_WDCNN_OUT \
  ai_wdcnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WDCNN_OUT_SIZE { \
  AI_WDCNN_OUT_1_SIZE, \
}
#define AI_WDCNN_OUT_SIZE_BYTES { \
  AI_WDCNN_OUT_1_SIZE_BYTES, \
}
#define AI_WDCNN_OUT_1_CHANNEL     (10)
#define AI_WDCNN_OUT_1_SIZE        (10)
#define AI_WDCNN_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_WDCNN_N_NODES (18)
 ...
 * @ref ai_wdcnn_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_wdcnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_WDCNN_*
 * defines into file @ref wdcnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
